...
int oneWireSM(Event evt){
	...
	case IDLE_STATE:
		switch(evt){
      case START_EVT:
    	  registerCallbacks(uart1Tx, &oneWireSM, NULL);
    	  registerCallbacks(uart1Rx, &oneWireSM, NULL);
    	  registerCallbacks(timer2, &oneWireSM, NULL);
